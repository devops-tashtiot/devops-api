...
> Bucket URL configured via `CONFLUENCE_S3_PLUGINS_BASE_URL` (default: `http://localhost:9100/confluence-plugins`).
...
> Upload destination: `CONFLUENCE_S3_IMPORTS_BASE_URL` (default: `http://localhost:9100/confluence-space-imports`).  
> Poll tuning: `CONFLUENCE_JOB_POLL_INTERVAL` (default 2 s), `CONFLUENCE_JOB_MAX_POLLS` (default 60).
...
> Bucket URL configured via `CONFLUENCE_S3_IMPORTS_BASE_URL` (default: `http://localhost:9100/confluence-space-imports`).  
> Poll tuning: `CONFLUENCE_JOB_POLL_INTERVAL` (default 2 s), `CONFLUENCE_JOB_MAX_POLLS` (default 60).
