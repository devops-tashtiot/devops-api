from .schemas import ChatMessage, MessageStatus, ChatMessageRequest
...
def get_v1_chat_router(chat_client: Any):
    ...
    async def send_message(payload: ChatMessageRequest) -> MessageStatus:
        return await send_message_operation(chat_client, payload.spec)
