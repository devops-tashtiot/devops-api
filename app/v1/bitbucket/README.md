...
| `public` | boolean | no | default `false` | Whether the project is publicly visible |
...
Creates a mirror project (key derived from name) and grants PROJECT_ADMIN to the specified user.

**Request body**

| Field | Type | Required | Constraints | Description |
|---|---|---|---|---|
| `name` | string | yes | max 255 | Mirror project name; key is auto-generated as `NAME_UPPERCASED` |
| `admin_user` | string | yes | `^[a-z0-9]+$`, max 15 | Username to receive PROJECT_ADMIN |
